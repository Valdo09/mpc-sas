            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{route('avis.update',['id'=>$avis->id])}}" id="create-form" method="POST" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="form-group">
                                    <label>Nom : </label>
                                <input type="text" name="nom" class="form-control input-default" value="{{ $avis->nom }}">
                                </div>
                                <div class="form-group">
                                    <label>Fonction : </label>
                                    <input type="text" name="fonction" class="form-control input-default" value="{{ $avis->fonction }}">
                                </div>
                                <div class="form-group">
                                    <label>Avis : </label>
                                    <textarea class="form-control editor" rows="5" id="avis" name="avis">{{ $avis->avis }}</textarea>
                                </div>
