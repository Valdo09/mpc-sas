    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title"><a href="javascript:void(0)">Prestation  </a> <i class="fa fa-angle-right"></i> <a href="javascript:void(0)">Ajout</a></h4>
                        <p>Veuillez remplir les champs suivants :</p>
                        <div class="basic-form">
                        <form action="{{route('prestations.store')}}" id="create-form" method="POST" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="form-group">
                                    <label>Nom : </label>
                                    <input type="text" value="{{ old('nom') }}" name="nom" class="form-control input-default @error('nom')
                                        is-invalid
                                    @enderror">
                                    @error('nom')
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control editor @error('description')
                                        is-invalid
                                    @enderror" rows="10" id="description" name="description">{{ old('description') }}</textarea>
                                    @error('description')
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped " id="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <th>{{$i}}</th>
                                        <!-- <td><img src="{{asset('assets/prestations/'.$prestation->image)}}" alt="" class="img-thumbnail"  style="width: 250px; height: 100px; background-color: white;"></td> -->
