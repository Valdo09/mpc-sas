														...
														<table class="center" cellpadding="0" cellspacing="0">
															<tr>
																{{-- <td style="line-height:0;">
																	<a target="_blank" style="text-decoration:none;" href="https://www.mllrenovation.fr/"><img src="{{ asset('public/logo_mpc.jpeg')}}" border="0" style="font:bold 12px/12px Arial, Helvetica, sans-serif; color:#606060; height: 60px;   width: 60px;" align="left" vspace="0" hspace="0"  alt="MLLRENOVATION.FR" /></a>
																</td> --}}
																<td>
																	<a target="_blank" href="https://www.mllrenovation.fr/" style="text-decoration:none; font:bold 12px Arial, Helvetica, sans-serif; color:#606060;">MPC</a>
																</td>
															</tr>
														</table>
													</th>
														...
														<table width="100%" cellpadding="0" cellspacing="0">
															<tr>
																<td data-color="text" data-size="size navigation" data-min="10" data-max="22" data-link-style="text-decoration:none; color:#888;" class="nav" align="right" style="font:bold 13px/15px Arial, Helvetica, sans-serif; color:#888;">
																	<a target="_blank" style="text-decoration:none; color:#888;" href="{{ route('welcome')."#nous" }}">Accueil</a> &nbsp; &nbsp; <a target="_blank" style="text-decoration:none; color:#888;" href="{{ route('welcome')."#prestations" }}">Prestations</a> &nbsp; &nbsp; <a target="_blank" style="text-decoration:none; color:#888;" href="{{ route('welcome')."#contact" }}">Contact</a>
																</td>
															</tr>
														</table>
													</th>
					...
					<table data-module="module-2" data-thumb="" width="100%" cellpadding="0" cellspacing="0">
						<tr>
							<td data-bgcolor="bg-module" bgcolor="#eaeced">
								<table class="flexible" width="600" align="center" style="margin:0 auto;" cellpadding="0" cellspacing="0">
									<tr>
										<td class="img-flex"><img src="{{ asset('public/assets/news/'.$image) }}" style="vertical-align:top;" width="600" height="306" alt="" /></td>
									</tr>
									<tr>
														...
														<table width="134" align="center" style="margin:0 auto;" cellpadding="0" cellspacing="0">
															<tr>
																<td data-bgcolor="bg-button" data-size="size button" data-min="10" data-max="16" class="btn" align="center" style="font:12px/14px Arial, Helvetica, sans-serif; color:#f8f9fb; text-transform:uppercase; mso-padding-alt:12px 10px 10px; border-radius:2px;" bgcolor="#7bb84f">
																	<a target="_blank" style="text-decoration:none; color:#f8f9fb; display:block; padding:12px 10px 10px;" href="https://mllrenovation.fr">Voir Plus</a>
																</td>
															</tr>
														</table>
													</td>
															...
															<tr>
																<td data-color="text" data-link-color="link text color" data-link-style="text-decoration:underline; color:#797c82;" class="aligncenter" style="font:12px/16px Arial, Helvetica, sans-serif; color:#797c82; padding:0 0 10px;">
                                                                    ...
                                                                    <form action="{{route('newsletters.destroy',['newsletter'=>$newsletter])}}" method="POST">
                                                                        @csrf
                                                                        @method('DELETE')
																	    MLL RENOVATION, 2021. &nbsp; Tous droits réservés.
                                                                        {{-- <button type="submit" style="text-decoration:underline; color:#797c82;">Se désabonner.</button> --}}
                                                                    </form>
																</td>
															</tr>
														</table>
														...
														<table class="center" align="right" cellpadding="0" cellspacing="0">
															<tr>
																<td class="btn" valign="top" style="line-height:0; padding:3px 0 0;">
																	<a target="_blank" style="text-decoration:none;" href="#"><img src="{{ asset('public/assets/images/ico-facebook.png') }}" border="0" style="font:12px/15px Arial, Helvetica, sans-serif; color:#797c82;" align="left" vspace="0" hspace="0" width="6" height="13" alt="fb" /></a>
																</td>
																<td width="20"></td>
																<td class="btn" valign="top" style="line-height:0; padding:3px 0 0;">
																	<a target="_blank" style="text-decoration:none;" href="#"><img src="{{ asset('public/assets/images/ico-twitter.png') }}" border="0" style="font:12px/15px Arial, Helvetica, sans-serif; color:#797c82;" align="left" vspace="0" hspace="0" width="13" height="11" alt="tw" /></a>
																</td>
																<td width="20"></td>
																<td class="btn" valign="top" style="line-height:0; padding:3px 0 0;">
																	<a target="_blank" style="text-decoration:none;" href="#"><img src="{{ asset('public/assets/images/ico-linkedin.png') }}" border="0" style="font:12px/15px Arial, Helvetica, sans-serif; color:#797c82;" align="left" vspace="0" hspace="0" width="13" height="11" alt="in" /></a>
																</td>
															</tr>
														</table>
													</th>
